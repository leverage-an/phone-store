      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mb-6 p-4 bg-primary-50 rounded-lg border border-primary-200">
            <h3 className="font-bold mb-2 text-primary-800">บริการของเรา</h3>
            <p className="text-gray-700 leading-relaxed text-sm">
              💻 <strong>ซ่อมโทรศัพท์</strong> - ซ่อมหน้าจอ, แบตเตอรี่, กล้อง และอุปกรณ์ทุกชนิด<br />
              📱 <strong>ลงรอม</strong> - อัพเกรดระบบ ปรับแต่งตามต้องการ<br />
              🔓 <strong>ปลดล็อก</strong> - ปลดล็อก Android / iPhone ทุกรุ่น<br />
              ⚡ <strong>ครบวงจร</strong> - รับประกันงานทุกงาน
            </p>
          </div>
